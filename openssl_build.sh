...
then
    ...
    ./Configure android-arm -DANDROID_API=${ANDROID_TARGET_API} no-tests --prefix=${OUTPUT_PATH}
    build_library
...
then
    ...
    cd ${OPENSSL_TMP_FOLDER}
    ./Configure android-arm64 -DANDROID_API=${ANDROID_TARGET_API} no-tests --prefix=${OUTPUT_PATH}
    build_library
...
then
    ...
    cd ${OPENSSL_TMP_FOLDER}
    ./Configure android-mips -DANDROID_API=${ANDROID_TARGET_API} no-tests --prefix=${OUTPUT_PATH}
    build_library
...
then
    ...
    cd ${OPENSSL_TMP_FOLDER}
    ./Configure android-mips64 -DANDROID_API=${ANDROID_TARGET_API} no-tests --prefix=${OUTPUT_PATH}
    build_library
...
then
    ...
    cd ${OPENSSL_TMP_FOLDER}
    ./Configure android-x86 -DANDROID_API=${ANDROID_TARGET_API} no-tests --prefix=${OUTPUT_PATH}
    build_library
...
then
    ...
    cd ${OPENSSL_TMP_FOLDER}
    ./Configure android-x86_64 -DANDROID_API=${ANDROID_TARGET_API} no-tests --prefix=${OUTPUT_PATH}
    build_library
